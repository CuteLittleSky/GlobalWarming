...
public final class Items {
    ...
    public static final SlimefunItemStack AIR_COMPRESSOR_2 = new SlimefunItemStack("AIR_COMPRESSOR_2", Material.DISPENSER, "&e二阶&a空气压缩机", "", "&a可以压缩二氧化碳", "&c压缩的效率更高 &b(8x)", "&7实际速度可能会受到其他因素影响,但基本秒出", "", LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), LoreBuilder.powerBuffer(4096), LoreBuilder.powerPerSecond(256));
    public static final SlimefunItemStack AIR_COMPRESSOR = new SlimefunItemStack("AIR_COMPRESSOR", Material.DISPENSER, "&b空气压缩机", "", "&a可以压缩二氧化碳", "", LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), LoreBuilder.powerBuffer(512), LoreBuilder.powerPerSecond(32));
